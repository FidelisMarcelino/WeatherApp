...
export default function Weather() {
  ...
  return (
    <div className="p-4 bg-gradient-to-tr from-pink-500 via-purple-800 to-red-400 min-h-screen">
      <h1 className="text-5xl font-bold m-4 text-gray-200 text-center">
        Weather App
      </h1>
      ...
      <div>
        ...
        {loading ? (
                ...
                <>
                  ...
                  <div className="gap-4 flex overflow-x-auto space-x-2 pb-2 styled-scrollbar cursor-grab active:cursor-grabbing">
                    {weather.forecast.forecastday[0].hour.map((hour, index) => (
                      <div
                        key={index}
                        className="bg-slate-800 rounded-lg p-4 min-w-[calc(100%/8)] flex-shrink-0 items-center shadow p-3 text-center"
                      >
                ...
                <>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4">
                    {weather.forecast.forecastday.map((day, index) => (
                      <div
                        key={index}
                        className="bg-slate-800 rounded-lg p-4 text-center shadow"
                      >
                        <p className="font-semibold">
          ...
          <p className="mt-4 text-center text-2xl font-semibold text-red-200">
            No data yet
          </p>
        )}
      </div>
